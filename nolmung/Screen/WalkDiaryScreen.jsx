    ...
    <>
      ...
      <View style={Styles.container}>
        <View style={Styles.selectBox}>
            <TouchableOpacity onPress={onPressMyWalk} style={select =='myWalk' ? Styles.bottomBorder : Styles.selectTextHuman}>
                <View>
            ...
            <TouchableOpacity onPress={onPressWalkStatistic} style={select =='walkStatistic' ? Styles.bottomBorder : Styles.selectTextHuman}>
                <View>
                    <Text style={{fontSize:15, color: '#282828',textAlign:'center',marginBottom:5,}}>
                      산책 통계
                    </Text>
